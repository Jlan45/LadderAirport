...
const file_agent_v1_agent_proto_rawDesc = "" +
	...
	"\amessage\x18\x03 \x01(\tR\amessage2\xd1\x03\n" +
	"\fAgentControl\x125\n" +
...
var file_agent_v1_agent_proto_depIdxs = []int32{
	0,  // 0: agent.v1.AgentControl.Ping:input_type -> agent.v1.PingRequest
	2,  // 1: agent.v1.AgentControl.ApplyConfig:input_type -> agent.v1.ApplyConfigRequest
	4,  // 2: agent.v1.AgentControl.Start:input_type -> agent.v1.StartRequest
	6,  // 3: agent.v1.AgentControl.Stop:input_type -> agent.v1.StopRequest
	8,  // 4: agent.v1.AgentControl.GetStatus:input_type -> agent.v1.GetStatusRequest
	10, // 5: agent.v1.AgentControl.GetMetrics:input_type -> agent.v1.GetMetricsRequest
	12, // 6: agent.v1.AgentControl.StreamLogs:input_type -> agent.v1.StreamLogsRequest
	1,  // 7: agent.v1.AgentControl.Ping:output_type -> agent.v1.PingResponse
	3,  // 8: agent.v1.AgentControl.ApplyConfig:output_type -> agent.v1.ApplyConfigResponse
	5,  // 9: agent.v1.AgentControl.Start:output_type -> agent.v1.StartResponse
	7,  // 10: agent.v1.AgentControl.Stop:output_type -> agent.v1.StopResponse
	9,  // 11: agent.v1.AgentControl.GetStatus:output_type -> agent.v1.GetStatusResponse
	11, // 12: agent.v1.AgentControl.GetMetrics:output_type -> agent.v1.GetMetricsResponse
	13, // 13: agent.v1.AgentControl.StreamLogs:output_type -> agent.v1.LogLine
